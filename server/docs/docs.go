    ...
    "paths": {
        ...
        "/article/updateArticle/:id": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"success\":true, \"msg\":\"更新成功\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/server_model_system_response.LoginResponse"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
    ...
    "definitions": {
        "app.Article": {
            ...
            "properties": {
                ...
                "title": {
                    "description": "TagId   int    ` + "`" + `json:\"tag_id\" form:\"tag_id\" gorm:\"column:tag_id;comment:标签ID;\"` + "`" + `",
                    "type": "string"
                },
                "updatedAt": {
                    "description": "更新时间",
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "email": {
                    "$ref": "#/definitions/server_config.Email"
                },
                "excel": {
        ...
        "server_model_system_response.LoginResponse": {
            "type": "object",
            "properties": {
                "expiresAt": {
                    "type": "integer"
